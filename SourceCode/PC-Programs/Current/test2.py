...
class main_panel(wx.Panel):
    def __init__(self, parent):
        wx.Panel.__init__(self, parent=parent)    #init panel
        ...
        btni1=wx.ToggleButton(self, -1, label=('Inverter 1'))  #first inverter button intialization
        btni2=wx.ToggleButton(self, -1, label=('Inverter 2'))  #second ...
        self.labeliv= wx.StaticText(self, label='0.00V', size = (50,20), style=wx.ALIGN_CENTRE) #inverter voltage value label
        self.labelic= wx.StaticText(self, label='0.00A', size = (50,20), style=wx.ALIGN_CENTRE) #inverter current ...
        ...
        self.labeli1= wx.StaticText(self, label='1', size = (20,20), style=wx.ALIGN_CENTRE)
        self.labeli2= wx.StaticText(self, label='2', size = (20,20), style=wx.ALIGN_CENTRE)
        ...
        btnf1=wx.ToggleButton(self, -1, label=('Filter 1'))    #intialize filter buttons
        btnf2=wx.ToggleButton(self, -1, label=('Filter 2'))
        btnf3=wx.ToggleButton(self, -1, label=('Filter 3'))
        self.labelfv= wx.StaticText(self, label='0.00V', size = (50,20),  style=wx.ALIGN_CENTRE)    #voltage value label
        self.labelfc= wx.StaticText(self, label='0.00A', size = (50,20),  style=wx.ALIGN_CENTRE)    #current...
        ...
        self.labelf1= wx.StaticText(self, label='1', size = (20,20), style=wx.ALIGN_CENTRE) #filter 1 label initialization & on/off color coding
        self.labelf2= wx.StaticText(self, label='2', size = (20,20), style=wx.ALIGN_CENTRE) #filter 2 ...
        self.labelf3= wx.StaticText(self, label='3', size = (20,20), style=wx.ALIGN_CENTRE) #filter 3 ...
        ...
        btnload1=wx.ToggleButton(self, -1, label=('Load 1'))   #initialize load buttons
        btnload2=wx.ToggleButton(self, -1, label=('Load 2'))
        btnload3=wx.ToggleButton(self, -1, label=('Load 3'))  
        ...
        self.labelload1= wx.StaticText(self, label='1', size = (20,20), style=wx.ALIGN_CENTRE)  #on/off color coded labels
        self.labelload2= wx.StaticText(self, label='2', size = (20,20), style=wx.ALIGN_CENTRE)
        self.labelload3= wx.StaticText(self, label='3', size = (20,20), style=wx.ALIGN_CENTRE)
        ...
        self.labelload1v= wx.StaticText(self, label='0.00V', size = (50,20), style=wx.ALIGN_CENTRE) #init current and voltage labels for all 3 loads
        self.labelload1c= wx.StaticText(self, label='0.00A', size = (50,20), style=wx.ALIGN_CENTRE)
        self.labelload2v= wx.StaticText(self, label='0.00V', size = (50,20), style=wx.ALIGN_CENTRE)
        self.labelload2c= wx.StaticText(self, label='0.00A', size = (50,20), style=wx.ALIGN_CENTRE)
        self.labelload3v= wx.StaticText(self, label='0.00V', size = (50,20), style=wx.ALIGN_CENTRE)
        self.labelload3c= wx.StaticText(self, label='0.00A', size = (50,20), style=wx.ALIGN_CENTRE)
        ...
        self.labelsys= wx.StaticText(self, label='ON', size = (100,20), style=wx.ALIGN_CENTRE)  #sys on/off label
        self.labelwifi= wx.StaticText(self, label='Connected', size = (100,20), style=wx.ALIGN_CENTRE)  #wifi connected/disconnected label
        self.labeltime= wx.StaticText(self, label='00:00 xx/xx/xx', size = (100,20), style=wx.ALIGN_CENTRE) #uptime label
...
#################################################################################
        ...
        #self.fft_button = wx.Button(self, -1 , "fft-off")
        ...
        self.SetSizer(self.vbox)    #link sizer functionality to main panel
        #self.vbox.Fit(self)
...
class mf(wx.Frame): #Main frame
    ...
    def __init__(self): #inital values
        ...
        self.panel_one = main_panel(self)
    ...
    def create_menu(self):
        ...
        m_config_mode = mode_menu.Append(1, 'Configuration Mode') #Configuration and kids mode subsections of mode
        m_kids_mode = mode_menu.Append(1, 'Kids Mode')
        g_save = graph_menu.Append(1, 'Save')
...
#            self.statusbar.SetStatusText('') 
    ...
    def on_config_mode(self, e):    #configuration frame event
        config = sp()
        #config.Show()
    
    def on_kids_mode(self, e):    #kids frame event
        kids = tp()
        #kids.Show()

    

class sp(wx.Panel): #configuartion frame
    def __init__(self):
        panel = wx.Panel(self)#init panel
        
    
class tp(wx.Frame): #kids frame
    def __init__(self):
        panel = wx.Panel(self)  #init panel
