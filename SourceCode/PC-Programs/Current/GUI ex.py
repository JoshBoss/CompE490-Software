...
#        
#    def init_plot(self):
#        self.fig2 = Figure((self.size_hor, self.size_ver), dpi=self.dpi)
#       
#        self.axes = self.fig2.add_subplot(111)
...
#        self.plot_data = self.axes.plot(self.bottom_x, self.bottom_y,linewidth=1,color=(1 , 0, 1)) [0]
#  
#    def figure(self):
#        return self.fig2
#        
...
#            self.plot_data.set_xdata(self.bottom_x)
#            self.plot_data.set_ydata(self.bottom_y)  
#            self.canvas_bottom.draw()
            
#class label:
#    def __init__(self, title, back_color, size):
#            self.title = title
#            self.back_color = back_color
#            self.size = size
#    def label(self):
#            self.lbl = wx.StaticText(self.panel, label = self.label,
#                        size = self.size, style = wx.ALIGN_CENTRE)
#    def color(self):        
#            self.lbl.SetBackGroundColour(self.back_color)
...
class mf(wx.Frame): #Main frame
    ...
    def __init__(self): #inital values
        ...
        self.bottom_x = [self.getdata.Data_bottom_x()]
        self.bottom_y = [self.getdata.Data_bottom_y()]
        #self.graphh = graph(3.0,3.0,'Voltage')
    ...
    def main_panel(self):
        ...
        #self.graphh.init_plot()
        #self.fig2 = [self.graphh.figure()]
        ...
        #self.labeli1 = self.label(self, '1', 'green', (20,20))
        #self.labeli1.label()
...
#####################################
        ...
        #self.vbox.Add(self.canvas_bottom, proportion=1, flag=wx.EXPAND)
