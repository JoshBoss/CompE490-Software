...
#################################################################################                    
    ...
    def draw_plot(self):
	    ...
	    if 'i1' in PlottingGraphs:
	        self.axes1.plot(i1Array) #Redraw the plot
		try:
			self.axes2.stem(ffti1[3:60:6])
		except:
		...
		self.axes1.plot(i2Array) #Redraw the plot
		try:
			self.axes2.stem(ffti2[3:60:6])
		except:
		...
		self.axes1.plot(i3Array) #Redraw the plot
		try:
			self.axes2.stem(ffti3[3:60:6])
		except:
	    ...
	    self.axes4.stem(fftVoltageArray[3:60:6])
	...
	if(result == wx.ID_OK):
		DRR = int(settingsDlg.DRR, 2)
		STO = int(settingsDlg.STO, 2)
		IP = settingsDlg.IP
	settingsDlg.Destroy()
