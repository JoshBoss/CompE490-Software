...
class main_frame(wx.Frame): #Main frame
    ...
    def __init__(self): #inital values
        ...
        wx.Frame.__init__(self,None, title = 'Main Mode', size=(1100,810)) #initialize frame
    ...
    def InitUI(self):
        ...
        self.graph = Graph(self.panel, -1, 400, 400, "hello")
#################################################################################
        self.vbox.Add(self.canvas, proportion=1,  flag=wx.EXPAND) #############################################
#################################################################################
        self.vbox.Add(self.graph, proportion=1,  flag=wx.EXPAND)                     
